...
void Application::Run() {
  ...
  while (bRunning) {
    ...
    // NOTE TO SELF 22/11/25 -- We split the for loop into two separate for
    // loops to guarantee that game logic happens before rendering the ImGui
    // shit
...
void Application::OnEvent(Event &e) {
  ...
  // Send the event from the bottom to the top. This ensures that layers like
  // the editor layer get it first...
