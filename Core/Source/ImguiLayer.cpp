...
// Initialise ImGui. Be careful not to call this multiple times! We may only have one context of ImGui active at once.
  IMGUI_CHECKVERSION();
  ImGui::CreateContext();
...
// Setup ImGui theme
// CREDIT : Comfy style by Giuseppe from ImThemes
